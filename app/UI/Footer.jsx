...
const Footer = () => {
  return (
    <footer className="p-6 py-10 rounded">
      {/* Footer Content */}
      <div className="container grid grid-cols-1 gap-8 mx-auto sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Quick Links */}
        <div>
          <h2 className="mb-4 text-lg font-bold text-amber-500">Quick Links</h2>
          <ul className="space-y-2">
            <li>
              <Link href="/movies" className="transition hover:text-amber-500">
                Movies
              </Link>
            </li>
            <li>
              <Link href="/tv" className="transition hover:text-amber-500">
                TV Shows
              </Link>
            </li>
            <li>
              <Link href="/profile" className="transition hover:text-amber-500">
                My Profile
              </Link>
            </li>
            <li>
        ...
        {/* Social Media */}
        <div>
          <h2 className="mb-4 text-lg font-bold text-amber-500">Follow Us</h2>
        ...
        {/* Newsletter */}
        <div>
          <h2 className="mb-4 text-lg font-bold text-amber-500">Newsletter</h2>
          <p className="mb-4 text-sm">
          ...
          <form className="flex flex-col gap-2">
            <input
              ...
              className="w-full px-4 py-2 text-sm text-gray-200 placeholder-gray-400 bg-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-amber-500"
      ...
      <div className="pt-6 mt-8 text-center border-t border-gray-700">
        <p className="text-sm">
          © 2024 ReflectYr. All rights reserved. Built by{" "}
