...
export default function UserList({
  ...
  return (
    <section className="flex flex-col gap-6 p-4 bg-gray-200 shadow-xl dark:bg-gray-800 rounded-xl">
      ...
      {/* Numbered List - Now using Flex */}
      <ol className="flex flex-col gap-4 overflow-y-auto">
        {userList.map((movie, index) => (
          <li
            key={index}
            className="flex items-center justify-between p-4 transition-all duration-200 bg-gray-100 rounded-lg shadow-md hover:bg-white hover:shadow-md dark:bg-gray-700 dark:hover:bg-gray-600"
          >
